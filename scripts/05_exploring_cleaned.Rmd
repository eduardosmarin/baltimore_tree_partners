...
# TODO, give "itree" a better name like "itree_sp_code" or similar


# TODO, fix missing State values
blue_water_baltimore_data_check |> st_drop_geometry() |> tabyl(city, state) # missing state values
...
# TODO multiple education by 100 to make percent, and add "pct_" to column name
blue_water_baltimore_data_check %$% cor.test(at_least_hs, at_least_college)

blue_water_baltimore_data_check %$% cor.test( median_household_income, at_least_college) # good.
