...
`r paste0(figure_4_tree_neighborhoods_layer |>
arrange(desc(Number_of_Trees)) |> slice(1:4) |> pull(Neighborhood),
collapse = ", ")` and `r paste0(figure_4_tree_neighborhoods_layer |>
arrange(desc(Number_of_Trees)) |> slice(5) |> pull(Neighborhood))`
