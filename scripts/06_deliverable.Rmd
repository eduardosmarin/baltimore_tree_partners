...
## Tree Giveaways Over the Past Ten Years

The following presentation is an entry-level analysis of the past **ten
years**, from 2013 to 2014, of Blue Water Baltimore's tree giveaways
program.

The document was prepared by **Dexter H. Locke** and **Eduardo Marin**.
The research was analyzed through six different lens, being the
following:
...
> The data will weave a powerful narrative, showcasing the distinctive
> and meaningful contributions of Blue Water Baltimore to our community.
...
program, there has been a total of
**`r nrow(blue_water_giveaway_data)`** tree giveaways. Although the
number is an overestimate since 2017 and 2018 included TreeBaltimore's
values, the impact is undeniable. Blue Water's tree plantings have
reached homeowners across the state of Maryland, from Frederick to
Caroline County.
...
Of course, most of these tree plantings have went to homeowners within
