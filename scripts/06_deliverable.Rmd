...
**Graph 1. Line Graph of Tree Giveaways over the Years**
...
**Graph 2. Line Graph of Tree Giveaways over the Years by Season**
...
Table 1. Table of Tree Giveaways over the Year (per Jurisdiction)
...
**Figure 2. Map of Tree Giveaway Plantings in Maryland (Over Time):**
...
**Figure 3.** Map of Tree Plantings in Baltimore Neighborhoods
...
# `r figure_4_tree_neighborhoods_layer |> arrange(desc(Number of Trees)) |> slice(1:9) |> pull(Name) |> paste(collapse = ", ")`, followed by `r figure_4_tree_neighborhoods_layer |> arrange(desc(Number of Trees)) |> slice(10) |> pull(Name)`, #TODO: FIX THIS
```

As previously noted, a significant proportion of total tree plantings has been concentrated in Northeast, Central, and Southeast Baltimore. Specifically, the top ten neighborhoods with the highest number of tree plantings are listed in descending order.
...
ggsave(
  filename = file.path("../baltimore_tree_partners/deliverables", "location_graph_3_tree_plantings_neighborhoods_year.png"), #TODO: Fix to make more general file saving path
...
**Graph 4. Graph of Tree Plantings in Maryland (per Year and Season)**
...
ggsave(
  filename = file.path("../baltimore_tree_partners/deliverables", "location_graph_2_tree_plantings_jurisdiction.png"), #TODO: Fix to make more general file saving path
...
# ggsave(
#   filename = file.path("../baltimore_tree_partners/deliverables", "provider_graph_4_tree_plantings_neighborhoods_year.png"), #TODO: Fix to make more general file saving path
...
blue_water_giveaway_data |>
  ...
  mapview(zcol = "common_name", col.regions = colors_species, layer.name = "Top 10 Tree Species Planted from Blue Water Baltimore") #TODO: Fix how they are being highlighted and the order
```
