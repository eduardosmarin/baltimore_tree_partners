...
##### Synced Map of Household Income and Giveaway Count (Per Census
Blocks)
```{r}
...
#### Graph of Percentage Increase Every Year
```{r}
bwb_total_giveaway_with_Tapestry_2019 |> 
  st_drop_geometry() |> 
  add_row(year = "2020") |> 
...
#Would page 13 be worth it? (tried doing this, however, confused on finding the population/shapefile of the original)
...
# https://rpkgs.datanovia.com/ggpubr/reference/stat_compare_means.html <- #tried doing this
```


#### Map of Tapestry Groups in Baltimore
```{r}
baltimore_2019_layer
```
