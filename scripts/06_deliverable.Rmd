...
#TODO: Dexter, unsure, how to get the count of households since the units are neighborhoods and not census blocks
```
...
ggsave(
  filename = file.path("../baltimore_tree_partners/deliverables", "location_graph_tree_plantings_neighborhoods_top_5year.png"), #TODO: Fix to make more general file saving path
...
lifeogroup_baltimore_years_facet #DEXTER: Better form to show this? Tried a density map but failed since lifegroups are categorical in nature
...
#TODO: Look at odds ratio at the old report for the affluent estates
...
#TODO (8/30): PERFORM SPATIAL JOIN
```
