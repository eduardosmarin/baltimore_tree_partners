...
#### serves as the inspiration for the later graphs: https://datavizcatalogue.com/search/comparisons.html
...
packs <-c(
          ...
          , 'classInt' #find me breaks without doing manual calculations
          )     
...
## making scatter plot dataframe
  ...
  rename("Median Household Income" = "median_household_income") |>
ggplot(aes(x = count, y = `Median Household Income`)) +
...
ggplot(aes(x = `Giveaway Count`, y = `At Least High School Degree or GED`)) +
  geom_point(color = "#abdda4") +
  scale_y_continuous(
      limits = c(0, 100),         
  ...
  labs(
    ...
    x = "Giveaway Count",
    y = "At Least High School Degree or GED"
  ) +
  theme_minimal() +
  NULL
```
...
```{r}
  ...
  rename("Giveaway Count" = "count", "Median Household Income" = "median_household_income") |>
ggplot(aes(x = `Giveaway Count`, y = `At Least Bachelor Degree`)) +
  geom_point(color = "#abdda4") +
  scale_y_continuous(
      limits = c(0, 100),         
      breaks = seq(0, 100, by = 20),  
...
bivariate_count_white_map <- 
  ...
  draw_plot(bivariate_count_white_map_legend, .25, .2, 0.2, 0.2)
...
## Scatter plot of white percentage and giveaway counts
  ...
  rename("Giveaway Count" = "count") |>
ggplot(aes(x = `Giveaway Count`, y = `White Percentage`)) +
  geom_point(color = "#abdda4") +
  scale_y_continuous(
      limits = c(0, 100),         
      breaks = seq(0, 100, by = 20),  
...
## Scatter plot of age percentage and giveaway counts
  ...
  mutate(count = case_when(
    ...
    TRUE ~ count)) |>
  rename("Giveaway Count" = "count") |>
ggplot(aes(x = `Giveaway Count`, y = `Median Age`)) +
  geom_point(color = "#abdda4") +
  scale_y_continuous(
      limits = c(0, 100),         
      breaks = seq(0, 100, by = 20),  
