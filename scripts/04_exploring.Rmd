...
link_color <- c(
  "Stillmeadow Community Fellowship" = "#262956",  
  "Herring Run Nursery" = "#262F5C",               
  "Ridgely Manor Park" = "#263761",                
  "Gwynns Falls Leakin Park" = "#254067",          
  "32nd Street Farmers Market" = "#254B6D",        
  "JFX Farmers Market" = "#245773",                
  "REI Timonium" = "#236579",                      
  "West Towson ES" = "#236579",                    
  "Cromwell Valley Harvest Festival" = "#22757F",  
  "Cromwell Valley Park" = "#218685",              
  "John Ruhrah ES" = "#208C7F",                    
  "Winand ES" = "#1F9376",                         
  "St Matthews Catholic Church" = "#1D9A6C",       
  "Cherry Hill Urban Garden" = "#2A9B4E",          
  "Langston Hughes Community Center" = "#369C38",  
  "Darley Park Gateway" = "#5C9D42",               
  "Anneslie" = "#7E9F4D",                          
  "Ridgeleigh" = "#9AA159",                        
  "Rodgers Forge" = "#A39664",                     
  "Stoneleigh" = "#A6896F",                        
  "Washington Hill Fall Community Day" = "#A98179",
  "Chestnut Hill" = "#AC8489"                   
)

#Making the layer of the link
link_layer <-
  link_read |>
  mapview(zcol = "giveaway_location", col.regions = link_color, layer.name = "Tree Giveaway Origin and Destination")
