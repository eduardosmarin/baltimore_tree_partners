...
- Year Map Overview (each color based off of year, plus Shiny app (filter for years))  
- Stacked Bar Chart of Each Year (each season as different colors)

**WHERE**

- Three Jurisdictions Map Overview (different colors based off of the three tree giveaway distribution)  
- Bar Chart (different colors based on the locations with count)  
- Baltimore Neighborhood Map Overview (different colors based on density of the plantings)  
- Bar Chart Highlighting Top 10 Planted Neighborhoods (different colors based on neighborhood), plus aggregating the rest as Other  
- Census Tract Overview in Baltimore (different colors based on density of the plantings)  
- Census Tract Overview in Baltimore County (different colors based on density of the plantings)  
...
- Map Overview of Top 5 Species each Season (each species as a different color, RShiny)  
