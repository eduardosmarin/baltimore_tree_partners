...
Rather than analyze a single sociodemographic or economic variable like median household income, it can be useful to categorize places based on multiple dimensions simultaneously. Geodemographic market segmentation is a suite of techniques ideally suited categorizing neighborhoods or Census block groups. Briefly, multiple characteristics are  
